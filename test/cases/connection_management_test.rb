...
module ActiveRecord4116
  module ConnectionAdapters
    class ConnectionManagementTest < ActiveRecord4116::TestCase
      class App
        attr_reader :calls
        def initialize
          @calls = []
      ...
      def setup
        ...
        assert ActiveRecord4116::Base.connection_handler.active_connections?
      end

      if Process.respond_to?(:fork)
        def test_connection_pool_per_pid
          object_id = ActiveRecord4116::Base.connection.object_id
          ...
          pid = fork {
            rd.close
            wr.write Marshal.dump ActiveRecord4116::Base.connection.object_id
            wr.close
            exit!
          }
