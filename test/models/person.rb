...
class PersonWithDependentDestroyJobs < ActiveRecord4116::Base
...
class PersonWithDependentDeleteAllJobs < ActiveRecord4116::Base
  self.table_name = 'people'
...
class PersonWithDependentNullifyJobs < ActiveRecord4116::Base
  self.table_name = 'people'
...
class LoosePerson < ActiveRecord4116::Base
  self.table_name = 'people'
...
class TightPerson < ActiveRecord4116::Base
  self.table_name = 'people'
...
class RichPerson < ActiveRecord4116::Base
  self.table_name = 'people'
...
class NestedPerson < ActiveRecord4116::Base
  self.table_name = 'people'
...
class SerializedPerson < ActiveRecord4116::Base
  self.table_name = 'people'
